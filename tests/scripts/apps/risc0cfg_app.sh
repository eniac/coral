...
do 
echo "$i"
RUST_BACKTRACE=1 RISC0_DEV_MODE=0 gtime -v -a -o ../../tests/results/memory/toml_t3_risc0_cfg ./target/release/validate_input ../../tests/test_docs/toml/t3.txt ../../grammars/toml.pest ../../tests/results/timings/toml_t3_risc0_cfg.txt
done

for i in {0..10}
do 
echo "$i"
RUST_BACKTRACE=1 RISC0_DEV_MODE=0 gtime -v -a -o ../../tests/results/memory/toml_t2_risc0_cfg ./target/release/validate_input ../../tests/test_docs/toml/t2.txt ../../grammars/toml.pest ../../tests/results/timings/toml_t2_risc0_cfg.txt
done

for i in {0..10}
do 
echo "$i"
RUST_BACKTRACE=1 RISC0_DEV_MODE=0 gtime -v -a -o ../../tests/results/memory/toml_t1_risc0_cfg ./target/release/validate_input ../../tests/test_docs/toml/t1.txt ../../grammars/toml.pest ../../tests/results/timings/toml_t1_risc0_cfg.txt
done
